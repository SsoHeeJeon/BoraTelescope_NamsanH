    ...
    public void Intelligence()
    {
        ...
        else if(GameManager.currentLang == GameManager.Language_enum.English)
        {
            ...
            if (info.ganzi[index]!="")
            {
                if(index == 2)
                {
                    Title.GetComponent<TMP_Text>().text = "Seon-Haeng-Ki-Eon (à»ú¼Ðìåë)\nYi-Hu-Zhong-Ji (ì»ý­ðôñý)";
                }
                else if(index ==3)
                {
                    Title.GetComponent<TMP_Text>().text = "Ki-Shin-Bu-Jeong (ÐìãóÝÕïá)\nSu-Ryeong-Bu-Jong (âÌÖµÝÕðô)";
                }
                else if(index ==13)
                {
                    Title.GetComponent<TMP_Text>().text = "Jeok-Seon-Ji-Ka (îÝà¼ñýÊ«)\nPil-You-Yeo-Kyoung (ù±êóæ®ÌÔ)";
                }
                else if(index ==14)
                {
                    Title.GetComponent<TMP_Text>().text = "Myeon-Il-Si-Ji-Bun (ìÛìéãÁñýÝÈ)\nMyeon-Paek-Il-Ji-Woo (ØóÛÝìíñýéØ)";
                }
                else if(index ==18)
                {
                    Title.GetComponent<TMP_Text>().text = "Ye-Sok-Sang-Kyo (ÖÉáÔßÓÎß)\nHwan-Nan-Sang-Hyul (ü´ÑñßÓýÑ)";
                }
                else
                {
